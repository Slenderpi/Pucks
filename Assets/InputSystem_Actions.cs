...
public partial class @InputSystem_Actions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""StepPucks"",
                    ""type"": ""Button"",
                    ""id"": ""26b4ab0d-7f72-455a-8ee1-e03c6a37f768"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                ...
                },
                {
                    ""name"": ""ChangePuckType"",
                    ""type"": ""Button"",
                    ""id"": ""1d063a61-84c7-4fd6-b1b4-479fc2a9b8fc"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""17eb4733-8bd8-42d5-a910-610f9ef163a3"",
                    ""path"": ""<Keyboard>/space"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""00545a35-2c93-425d-9eb8-f779396a47c8"",
                    ""path"": ""<Keyboard>/r"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""7ec79cd7-3632-45cc-b6cd-c81619b5c7a2"",
                    ""path"": ""<Keyboard>/p"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": [
        ...
        m_Debug_ChangePuckType = m_Debug.FindAction("ChangePuckType", throwIfNotFound: true);
        ...
        m_Example_Look = m_Example.FindAction("Look", throwIfNotFound: true);
        m_Example_Attack = m_Example.FindAction("Attack", throwIfNotFound: true);
        m_Example_Interact = m_Example.FindAction("Interact", throwIfNotFound: true);
        m_Example_Crouch = m_Example.FindAction("Crouch", throwIfNotFound: true);
        m_Example_Jump = m_Example.FindAction("Jump", throwIfNotFound: true);
        m_Example_Previous = m_Example.FindAction("Previous", throwIfNotFound: true);
        m_Example_Next = m_Example.FindAction("Next", throwIfNotFound: true);
        m_Example_Sprint = m_Example.FindAction("Sprint", throwIfNotFound: true);
        // UI
    ...
    ~@InputSystem_Actions()
    {
        ...
        UnityEngine.Debug.Assert(!m_Example.enabled, "This will cause a leak and performance issues, InputSystem_Actions.Example.Disable() has not been called.");
    ...
    private readonly InputAction m_Debug_ChangePuckType;
    ...
    public struct DebugActions
    {
        ...
        /// <summary>
        /// Provides access to the underlying input action "Debug/ChangePuckType".
        /// </summary>
        public InputAction @ChangePuckType => m_Wrapper.m_Debug_ChangePuckType;
        /// <summary>
        ...
        public void AddCallbacks(IDebugActions instance)
        {
            ...
            @ChangePuckType.started += instance.OnChangePuckType;
            @ChangePuckType.performed += instance.OnChangePuckType;
            @ChangePuckType.canceled += instance.OnChangePuckType;
    ...
    private List<IExampleActions> m_ExampleActionsCallbackInterfaces = new List<IExampleActions>();
    private readonly InputAction m_Example_Move;
    private readonly InputAction m_Example_Look;
    private readonly InputAction m_Example_Attack;
    private readonly InputAction m_Example_Interact;
    private readonly InputAction m_Example_Crouch;
    private readonly InputAction m_Example_Jump;
    private readonly InputAction m_Example_Previous;
    private readonly InputAction m_Example_Next;
    private readonly InputAction m_Example_Sprint;
    /// <summary>
    /// Provides access to input actions defined in input action map "Example".
    /// </summary>
    public struct ExampleActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public ExampleActions(@InputSystem_Actions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "Example/Move".
        /// </summary>
        public InputAction @Move => m_Wrapper.m_Example_Move;
        /// <summary>
        /// Provides access to the underlying input action "Example/Look".
        /// </summary>
        public InputAction @Look => m_Wrapper.m_Example_Look;
        /// <summary>
        /// Provides access to the underlying input action "Example/Attack".
        /// </summary>
        public InputAction @Attack => m_Wrapper.m_Example_Attack;
        /// <summary>
        /// Provides access to the underlying input action "Example/Interact".
        /// </summary>
        public InputAction @Interact => m_Wrapper.m_Example_Interact;
        /// <summary>
        /// Provides access to the underlying input action "Example/Crouch".
        /// </summary>
        public InputAction @Crouch => m_Wrapper.m_Example_Crouch;
        /// <summary>
        /// Provides access to the underlying input action "Example/Jump".
        /// </summary>
        public InputAction @Jump => m_Wrapper.m_Example_Jump;
        /// <summary>
        /// Provides access to the underlying input action "Example/Previous".
        /// </summary>
        public InputAction @Previous => m_Wrapper.m_Example_Previous;
        /// <summary>
        /// Provides access to the underlying input action "Example/Next".
        /// </summary>
        public InputAction @Next => m_Wrapper.m_Example_Next;
        /// <summary>
        /// Provides access to the underlying input action "Example/Sprint".
        /// </summary>
        public InputAction @Sprint => m_Wrapper.m_Example_Sprint;
        /// <summary>
        /// Provides access to the underlying input action map instance.
        /// </summary>
        ...
        public bool enabled => Get().enabled;
        /// <summary>
        /// Implicitly converts an <see ref="ExampleActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        ...
        /// If <paramref name="instance" /> is <c>null</c> or <paramref name="instance"/> have already been added this method does nothing.
        /// </remarks>
        /// <seealso cref="ExampleActions" />
        public void AddCallbacks(IExampleActions instance)
        {
            if (instance == null || m_Wrapper.m_ExampleActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_ExampleActionsCallbackInterfaces.Add(instance);
        ...
        /// </remarks>
        /// <seealso cref="ExampleActions" />
        private void UnregisterCallbacks(IExampleActions instance)
        {
            @Move.started -= instance.OnMove;
            @Move.performed -= instance.OnMove;
            @Move.canceled -= instance.OnMove;
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="ExampleActions.UnregisterCallbacks(IExampleActions)" />.
        /// </summary>
        /// <seealso cref="ExampleActions.UnregisterCallbacks(IExampleActions)" />
        public void RemoveCallbacks(IExampleActions instance)
        {
            if (m_Wrapper.m_ExampleActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }
        ...
        /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
        /// </remarks>
        /// <seealso cref="ExampleActions.AddCallbacks(IExampleActions)" />
        /// <seealso cref="ExampleActions.RemoveCallbacks(IExampleActions)" />
        /// <seealso cref="ExampleActions.UnregisterCallbacks(IExampleActions)" />
        public void SetCallbacks(IExampleActions instance)
        {
            foreach (var item in m_Wrapper.m_ExampleActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_ExampleActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    /// <summary>
    /// Provides a new <see cref="ExampleActions" /> instance referencing this action map.
    /// </summary>
    ...
    public interface IDebugActions
    {
        ...
        /// <summary>
        /// Method invoked when associated input action "StepPucks" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
        ...
        /// <summary>
        /// Method invoked when associated input action "ChangePuckType" is either <see cref="UnityEngine.InputSystem.InputAction.started" />, <see cref="UnityEngine.InputSystem.InputAction.performed" /> or <see cref="UnityEngine.InputSystem.InputAction.canceled" />.
        /// </summary>
        /// <seealso cref="UnityEngine.InputSystem.InputAction.started" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.performed" />
        /// <seealso cref="UnityEngine.InputSystem.InputAction.canceled" />
        void OnChangePuckType(InputAction.CallbackContext context);
        /// <summary>
